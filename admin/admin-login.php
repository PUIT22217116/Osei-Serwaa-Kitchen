...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($admin) {
        ...
        // Store username for profile/settings operations
...
<head>
    ...
    <title>Admin Login - Osei Serwaa Kitchen</title>
    ...
    <main>
        <div class="login-container">
            ...
            <div class="login-footer">
                <p>Powered by <a href="https://www.facebook.com/profile.php?id=100082206290703" target="_blank">AKA-TECH</a></p>
            </div>
        </div>
    </main>
</body>
